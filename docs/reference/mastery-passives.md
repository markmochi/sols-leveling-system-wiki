...
Mastery passives unlock automatically at levels **5, 10, 15, 20, 25, and 30**. They can be toggled from the Masteries tab and cost no aptitude points.

## STR Mastery — unarmed combat and hand mining
...
| Ore class | Normal passive | Titan Hands |
| --- | ---: | ---: |
| Common | 1.00s | 0.75s |
| Precious | 0.85s | 0.70s |
| Ancient debris | 6.00s | 5.25s |

## Weapon Mastery — melee weapons

| Level | Passive | Effect |
| ---: | --- | --- |
| 5 | Balanced Grip I | +5% attack speed. |
| 10 | Opening Strike | +7% damage while the target is above 80% health. |
| 15 | Rooted Stance | +10% knockback resistance. |
| 20 | Balanced Grip II | Total attack-speed bonus becomes +10%. |
| 25 | Executioner | +7% damage while the target is below 25% health. |
| 30 | Weapon Master | +5% weapon damage. |

## Range Mastery — bows and projectiles

| Level | Passive | Effect |
| ---: | --- | --- |
| 5 | Steady Aim | +7% released-projectile damage while not sprinting. |
| 10 | Longshot I | +7% damage at 16 blocks or farther. |
| 15 | Point Blank | +7% damage at 8 blocks or nearer. |
| 20 | Longshot II | A further +7% at 24 blocks or farther. |
| 25 | Hunter | +7% damage while the target is below 25% health. |
| 30 | Marksman | +5% ranged damage. |
